...
def test():
    full_int_models = [
        ...
        (
            "../spectrogram_models_from_notebooks/squeezenet/squeezenet_spec_16kHz_full_int_q.tflite",
            "SqueezeNet-Mel",
        ),
    ...
    test_spectrogram_ds = create_spectrograms_from_audio_dataset(
        test_dataset, sample_rate=16000
    )  # .cache().prefetch(tf.data.AUTOTUNE)
    spec_x_test_np, spec_y_test_np = convert_prefetchdataset_to_numpy_arrays(
        test_spectrogram_ds
    )
